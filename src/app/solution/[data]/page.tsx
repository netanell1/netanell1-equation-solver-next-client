            ...
            {error ? <div>
                ...
                : <div>
                    ...
                    <TypingAnimation animationDelay={4} classDivChildren=" mt-16 mb-16 flex mt-5 gap-5 justify-center">
                        <Link className="btn--blue" href={`${PathsItems.equationWithOneVariable.path}/${PathsItems.equationWithOneVariable.parmas}`}>{PathsItems.equationWithOneVariable.title}</Link>
                        <Link className="btn--ppurple" href={`${PathsItems.equationsWithTwoVariables.path}/${PathsItems.equationsWithTwoVariables.parmas}`}>{PathsItems.equationsWithTwoVariables.title}</Link>
                    </TypingAnimation>
                </div>
            }
        </div>
